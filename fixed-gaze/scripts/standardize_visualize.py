...
def sync_back_and_visualize(visualize_path, back_path, output_path):
    visualize_frames = open(output_path, 'w+')
...
def main():
    ...
    sync_back_and_visualize(args.visualize, args.back,'output/visualize_frames.csv')
